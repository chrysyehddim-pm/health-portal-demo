    ...
    badges: [
      {
        ...
        icon: 'fa-seedling',
        tone: 'emerald',
        description: '完成第一次動腦互動',
        rule: '任一動腦互動項目首次成功完成，即可取得。',
        earned: true,
        earnedAt: '2026/07/18',
        progress: 1,
        target: 1
      },
      {
        ...
        icon: 'fa-compass',
        tone: 'blue',
        description: '體驗 3 種不同的動腦互動',
        rule: '累積成功完成 3 種不同的動腦互動項目，各項目至少一次。',
        earned: true,
        earnedAt: '2026/08/03',
        progress: 4,
        target: 3
      },
      {
        ...
        rule: '同一個月內累積 7 個不同日期，至少成功完成一次動腦互動。每月重新計算。',
        earned: true,
        earnedAt: '2026/09/07',
        progress: 9,
        target: 7
      },
      {
        ...
        tone: 'purple',
        description: '累積完成 10 次動腦互動',
        rule: '不分互動項目與 Level，累積成功完成 10 次動腦互動。',
        earned: true,
        earnedAt: '2026/08/12',
        progress: 117,
        target: 10
      },
      {
        ...
        tone: 'rose',
        description: '累積完成 30 次動腦互動',
        rule: '不分互動項目與 Level，累積成功完成 30 次動腦互動。',
        earned: true,
        earnedAt: '2026/08/30',
        progress: 117,
        target: 30
      },
      {
        ...
        icon: 'fa-medal',
        tone: 'orange',
        description: '累積完成 100 次動腦互動',
        rule: '不分互動項目與 Level，累積成功完成 100 次動腦互動。',
        earned: true,
        earnedAt: '2026/09/08',
        progress: 117,
        target: 100
